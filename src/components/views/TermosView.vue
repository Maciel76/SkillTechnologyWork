        ...
        <div class="terms-container">
          ...
          <div class="legal-content">
            <section id="aceitacao" class="content-section">
              ...
              <p>
                Ao acessar e utilizar este site, você concorda em cumprir e
                estar vinculado aos seguintes termos e condições de uso. Se você
                não concordar com qualquer parte destes termos, não deverá
            ...
            <section id="direitos" class="content-section">
              ...
              <p>
                ...
                da Skill Technology ou de seus fornecedores de conteúdo e está
...
.highlight::after {
  ...
  width: 100%;
  height: 12px;
  background: rgba(151, 11, 132, 0.2);
  z-index: 0;
  border-radius: 4px;

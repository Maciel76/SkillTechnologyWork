...
export default {
  ...
  data() {
    return {
      ...
      texts: [
        {
          h1: "Transformamos Sua Ideia em um <span class='highlight'>Sistema Digital Completo</span>",
          p: "Da concepção ao lançamento, desenvolvemos sistemas, sites, aplicativos e automações usando IA e as melhores ferramentas do mercado.",
          link: "/contato",
          ctaText: "Solicite uma Consultoria Gratuita",
        },
        {
          h1: "Automatize Processos e <span class='highlight'>Economize Tempo</span>",
          p: "Integramos IA, APIs e sistemas existentes para eliminar tarefas manuais e acelerar seu negócio.",
          link: "/Services",
          ctaText: "Ver Nossos Serviços",
        },
        {
          h1: "Desenvolvimento na <span class='highlight'>Velocidade da Luz</span>",
          p: "Utilizamos as inteligências artificiais mais avançadas para entregar seu projeto com rapidez, qualidade e custo reduzido.",
          link: "/Portfolio",
          ctaText: "Ver Portfólio",
        },
        {
          h1: "Qualquer Sistema. Qualquer Integração. <span class='highlight'>Qualquer Automação.</span>",
          p: "Sites, aplicativos, lojas virtuais, sistemas web, integrações com APIs — se você sonha, nós construímos.",
          link: "/contato",
